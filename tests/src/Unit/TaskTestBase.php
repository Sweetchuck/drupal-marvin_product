...
use Drupal\Tests\marvin_product\Helper\DummyOutput;
use Drupal\Tests\marvin_product\Helper\TaskBuilder;
...
class TaskTestBase extends TestCase {
  ...
  /**
   * @var \Drupal\Tests\marvin_product\Helper\TaskBuilder
   */
